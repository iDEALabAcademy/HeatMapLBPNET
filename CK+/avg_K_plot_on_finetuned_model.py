...
MODEL_PATH = os.path.join(os.path.dirname(__file__), "CK_full_CNN_outputs", "masked_model_avg_top40.pth")
...
# ---------------------- Load Model ----------------------
print("\n🧠 Loading fine-tuned CK+ classifier (avg 40%)...")
...
plt.title("CK+ Per-Class Accuracy vs Top-K% on Fine-tuned Model (Avg 40%)", fontsize=16, fontweight='bold')
...
plt.tight_layout()
output_plot_path = os.path.join(os.path.dirname(__file__), "global_mask_topk_avg_vs_accuracy_on_finetuned40.png")
