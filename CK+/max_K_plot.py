...
plt.title("CK+ Per-Class Accuracy vs Top-K% Pixels in Global Mask (Max-based)", fontsize=16, fontweight='bold')
...
plt.tight_layout()
output_plot_path = os.path.join(os.path.dirname(__file__), "global_mask_topk_max_vs_accuracy.png")
