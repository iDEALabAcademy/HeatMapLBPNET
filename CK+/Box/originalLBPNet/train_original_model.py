#!/usr/bin/env python3
"""
Train LBPNet with original LBP layer on CK+
Adapted for CK+ dataset (7 emotion classes, 48x48 grayscale)
"""
...
PRESETS = {
    "paper_ckplus_rp": {
        ...
        # expected input image size (CK+ is 48x48)
        "image_size": 48,
        ...
        # Data augmentation (enabled for small CK+ dataset)
        "augment": {
            "enable": False,
            "crop_pad": 2,
            "rotation": 10
...
def get_config():
    ...
    if yaml_path and os.path.isfile(yaml_path):
        ...
        # Default preset for CK+
        preset = os.environ.get("MODEL_PRESET", "paper_ckplus_rp")
...
def train_original_model():
    print("🚀 Starting training LBPNet with the original LBP layer on CK+...")
    ...
    ckpt_default = os.path.join('./outputs_CKplus_original', 'best_model.pth')
    ...
    # Output dir
    output_dir = "./outputs_CKplus_original"
