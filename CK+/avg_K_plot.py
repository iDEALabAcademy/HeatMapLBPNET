...
top_k_percents = list(range(20, 105, 5))  # [20, 25, ...,]
...
plt.title("CK+ Per-Class Accuracy vs Top-K% Pixels in Global Mask (Average-based)", fontsize=16, fontweight='bold')
...
plt.tight_layout()
output_plot_path = os.path.join(os.path.dirname(__file__), "global_mask_topk_avg_vs_accuracy.png")
