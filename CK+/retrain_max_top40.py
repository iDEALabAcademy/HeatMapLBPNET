...
# ---------------------- Configuration ----------------------
MASK_PATH = "global_heatmap_max/global_max_binary_mask.npy"
PRETRAINED_MODEL_PATH = "CK_full_CNN_outputs/best_model.pth"
MODEL_SAVE_PATH = "CK_full_CNN_outputs/masked_model_max_top40.pth"
DATA_DIR = "ck_dataset"
BATCH_SIZE = 16
EPOCHS = 5
LEARNING_RATE = 1e-4
...
# ---------------------- Training Loop ----------------------
print("Fine-tuning on max-based masked dataset (40%)...")
...
sample_output_dir = "sample_masked_max_top40_for_retrain"
